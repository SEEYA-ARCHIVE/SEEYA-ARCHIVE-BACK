...
def get_review_image_path(self, filename):
    ...
    return os.path.join('review-images', current_date + file_extension[-1])
...
class Review(models.Model):
    ...
    like_users = models.ManyToManyField('accounts.User', related_name='like_reviews', blank=True, null=True)
...
class ReviewImage(models.Model):
    review = models.ForeignKey('seat_reviews.Review', related_name='images', on_delete=models.CASCADE)
